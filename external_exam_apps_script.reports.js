...
// Deployment: reports   (API_DEPLOYMENT — health reports it)
// Deploy (split, step א): paste this whole file into a NEW STANDALONE Apps Script project,
...
// Modules: 00_config, 05_registry, 10_spreadsheet, 08_pending_writes, 98_migration_practice, 12_reads, 14_pending_archive, 16_lookup_util, 18_whatsapp, 20_auth, 22_util, 24_triggers, 70_questions, 30_api, 82_report_center, 84_report_site, 62_practice, 75_diag, 86_commander, 88_predictive, 90_teacher, 92_at_risk, 94_forecast, 96_admin, 91_teacher_classes
// ============================================================================
