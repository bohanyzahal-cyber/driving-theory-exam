# Reliability release — 2026-09-05-r5
...
3. Check that the public health response reports `build: "2026-09-05-r5"`. A successful Pages deployment does not prove this server step occurred.
