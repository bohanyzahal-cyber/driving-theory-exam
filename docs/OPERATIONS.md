...
**מאז 21/09 בערב ה-Worker הוא תלות קשה של התחלת מבחן** (הטקסטים מגיעים רק ממנו) — כמו ש-Drive היה עד r30. הסקר עובר רק דרכו — אין נפילה לסקר ישיר ואין מתג ידני (יוסי, 21/09: "אין סיבה שיהיה דבר כזה"; ובערב: "Cloudflare הוא הדרך, בלי 'מה עושים אם'"); כשה-Worker לא עונה הדף מנסה שוב לבד עם backoff. **למחוק את `GATEWAY_URL` = אין טקסטים = אין מבחנים** — זה כבר לא מתג כיבוי אלא חלק מחזרה מלאה לאחור (`DEPLOY_2026-09-22.md` §8: גרסת Apps Script קודמת + לקוח r24 ב-Pages, שמקבל שאלות מהשרת). סטטוס Cloudflare: https://www.cloudflarestatus.com/.
