...
| חסר = אפס | **רק** ב‑`warn/fin/ext/dq`: שדה שאינו קיים, `''`, `0`, `'0'` ו‑`false` מוטבעים כולם כ‑`''` |
...
"code had hung", ו‑`cpuTime` של watch מוחזק נשאר חד‑ספרתי.
...
{"r":"watch","s":"R9UYX7DV","src":"memory","fp":"s:a79136fe0ef8","held":25000,
 "fl":3,"age":12840,"late":0,"up":712,"usfp":"s:a79136fe0ef8","rows":12}
```
